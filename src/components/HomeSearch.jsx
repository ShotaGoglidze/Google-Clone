...
import { BsArrowReturnLeft, BsFillMicFill } from 'react-icons/bs'
...
export default function HomeSearch() {
  ...
  return (
    <>
       <form
        className='flex w-full mt-5 mx-auto max-w-[90%] border border-gray-200 rounded-full px-5 py-3 hover:shadow-md focus-within:shadow-md transition-shadow sm:max-w-xl lg:max-w-2xl'
        onSubmit={handleSubmit}
       >
          <AiOutlineSearch className='text-xl text-gray-500 mt-0.5 mr-3' />
          <input
           type="text" 
           className='flex-grow focus:outline-none'
           onChange={e => setInput(e.target.value)}  
          />
          <BsFillMicFill className='text-lg mt-0.5' />
       </form>
